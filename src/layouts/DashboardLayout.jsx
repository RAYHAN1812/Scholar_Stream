...
const DashboardLayout = () => {
    const { user, loading, userRole, isAdmin, isModerator, isStudent } = useContext(AuthContext);

    if (loading) return <span className="loading loading-spinner loading-lg block mx-auto mt-20"></span>;
